...
<template>
    <NuxtLink :to="`/priceList/${item.id}`"
        class="block rounded-[28px] cursor-pointer bg-[#EAF2FF] overflow-hidden border border-[#D6E4FF] hover:shadow-lg transition shadow-2xl">
        <div class="flex items-center justify-center">
            <component :is="item.icon" class="w-[250px] h-[300px]" />
        </div>
