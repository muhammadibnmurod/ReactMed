...
<template>
    <div class="flex w-full flex-col px-14 items-start gap-[20px] py-10">
        <template v-if="category">
            ...
            <div v-for="(service, index) in category.services" :key="service.id" @click="openServiceDetails(service)"
                ...
                <div class="flex items-center">
                    <div class="flex py-[48px] px-[60px] rounded-l-[59.659px] justify-center items-center bg-[#C2DDFF]">
                        <p
